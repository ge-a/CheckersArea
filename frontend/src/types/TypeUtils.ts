...
/**
 * Test to see if an interactable is a checkersArea
 */
export function isCheckersArea(interactable: Interactable): interactable is CheckersArea {
  return 'board' in interactable;
}
